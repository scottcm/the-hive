...
async def _reset_db(db_pool) -> None:
    async with db_pool.connection() as conn:
        await conn.execute(
            """
            TRUNCATE hive.clarifications, hive.task_notes, hive.task_gate_events, hive.task_overrides, hive.task_evidence_artifacts, hive.task_contracts, hive.tasks, hive.milestones, hive.projects
